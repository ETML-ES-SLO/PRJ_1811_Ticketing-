...
//        case MENU_MenuPrincipal:
//        {
//            // 1) UP ou DOWN : on bascule la sélection entre Liste et Config
//            if (appButtons.But_UP || appButtons.But_Down)
//            {
//                MenuSelected = (MenuSelected == SELECTED_LIST)
//                             ? SELECTED_Configuration
//                             : SELECTED_LIST;
//                TFT_Cursor_MenuPrincipale();
//                ClearALLButtons();
//            }
//            // 2) OK : on entre dans la page sélectionnée
//            else if (appButtons.But_OK && MenuSelected != SELECTED_NONE)
//            {
//                MENUSELECT choice = MenuSelected;
//
//                // a) on efface la flèche du menu principal
//                MenuSelected = SELECTED_NONE;
//                TFT_Cursor_MenuPrincipale();
//
//                // b) on nettoie entièrement lécran
//                tft_fillScreen(ILI9341_BLACK);
//
//                // c) on affiche la sous-page adéquate
//                if (choice == SELECTED_LIST)
//                {
//                    MenuList = MENU_List;
//                    TFT_Font_List();
//                    if (Nb_Students_In_List > 9)
//                    TFT_aff_list_more(Nb_Students_In_List - 9);
//                }
//                else /* choice == SELECTED_Configuration */
//                {
//                    MenuList = MENU_Config;
//                    PosCursorConfig = 0;
//                    TFT_Font_config();
...
//            case MENU_List:
//            {
//                // In list view, use UP/DOWN to scroll
//                if (appButtons.But_UP && listStart > 0)
//                {
//                    listStart--;
//                    TFT_Show_List();
//                    ClearALLButtons();
//                }
//                else if (appButtons.But_Down && listStart + MAX_LINES < Nb_Students_In_List)
//                {
//                    listStart++;
//                    TFT_Show_List();
//                    ClearALLButtons();
...
//            break;
        case MENU_Config:
        {
            // Similar scrolling or config navigation
            if (appButtons.But_UP && PosCursorConfig > 0)
            {
                PosCursorConfig--;
//                TFT_Update_ConfigCursor(PosCursorConfig);
                ClearALLButtons();
            }
            else if (appButtons.But_Down && PosCursorConfig + 1 < I_Nbstudents)
            {
                PosCursorConfig++;
//                TFT_Update_ConfigCursor(PosCursorConfig);
                ClearALLButtons();
